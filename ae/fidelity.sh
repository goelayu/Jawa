...
#clean up
# rm -r ../data/performance/fidelity/original/*
# rm -r ../data/performance/fidelity/iphone/*
# rm -r ../data/performance/fidelity/jawa/0/*
# rm -r ../data/performance/fidelity/jawa/1/*

# cat ../sites/alexa/alexa-ae-fixed | head -n $1 | while read site ; do
...
ls ../data/performance/fidelity/original/ | while read site; do
    node utils/util.js -t matchNetCount -i ../data/performance/fidelity/original//$site/network  -a ../data/performance/fidelity/iphone//$site/network --site-type original
...
ls ../data/performance/fidelity/original/ | while read site; do
    node utils/util.js -t matchNetSize -i ../data/performance/fidelity/original//$site/network  -a ../data/performance/fidelity/iphone//$site/network --site-type original
...
cat ../data/results/fidelity/jawa.size | awk '{if (NF ==2 && $1 > 0) print ($1 - $2)/$1, ",Jawa"}' >> ../data/results/fidelity/size.p
cat ../data/results/fidelity/ia.size | awk '{if (NF ==2 && $1 > 0) print ($1 - $2)/$1, ",IA"}' >> ../data/results/fidelity/size.p
