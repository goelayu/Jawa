...
async function launch(){
    ...
    await initCDP(cdp);
    await page.setUserAgent("Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/73.0.3683.103 Safari/537.36 Crawls as a part of research experiment -- webarchive-research@umich.edu");
    if (program.network){
