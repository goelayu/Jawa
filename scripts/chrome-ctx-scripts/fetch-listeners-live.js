 ...
 * however in the live context: implying it will 
 * log evthandlers corresponding to resources as well
 *
 */
...
var all_handlers = ["abort", "blur", "change", "click", "close", "contextmenu", "dblclick", "focus",
    ...
    "mouseover", "mouseup", "reset", "resize", "scroll", "select", "submit" ,"load", "error"];

var IGNORE_ELEMENTS = ['INPUT','FORM','HTML']
