...
var intercepts = fs.readFileSync(
  "../program_analysis/runtime/dynamic-api-intercepts.js",
  "utf-8"
);
var customWombat = fs.readFileSync("../program_analysis/wombat.js", "utf-8");
...
async function launch() {
  ...
  // var firstRequest = true, mainDomain = "";
  // page.on('request', (request) => {
  //     var url = request.url();
  //     var domain = psl.get(extractHostname(url));
  //     if (firstRequest) {
  //         mainDomain = domain;
  //         firstRequest = false;
  //     }
