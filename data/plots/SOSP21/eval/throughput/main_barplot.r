...
# data$x <- factor(data$x, levels=c("ArchiveBox","Jawa\nbaseline","Jawa","Jawa w\o call\ngraph"))
my.labels <- c("ArchiveBox",
               "Jawa\nbaseline",
               "Jawa", 
               "Jawa w/o call\ngraph caching")
...
ggplot(data, aes(x=x,y=y)) +
    ...
    xlab("Crawler") +
    # ylab("Crawling throughput (normalized)") +
    ylab(expression(atop("Crawling throughput", paste("(Normalized)")))) + 
