...
data.log$Op <- "Runtime exceptions"
data.net$Op <- "Network errors"
data.log$network <- factor(data.log$network, levels=c('Live', 'Archive'))
...
pdf("errors.pdf", height=2.5, width=5)
